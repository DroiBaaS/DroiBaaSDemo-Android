...
public class GameFragment extends Fragment implements
    ...
    public void onResume() {
        super.onResume();
        DroiAnalytics.onFragmentStart(getActivity(), "GameFragment");
    }

    @Override
    public void onPause() {
        super.onPause();
        DroiAnalytics.onFragmentEnd(getActivity(), "GameFragment");
    }
    ...
    private void initHotApp(View view) {
        ...
        title.setText(getString(R.string.fragment_hot_game));
    ...
    private void fetchAppInfoData() {
        DroiCondition cond = DroiCondition.cond("mainType", DroiCondition.Type.EQ, "game");
