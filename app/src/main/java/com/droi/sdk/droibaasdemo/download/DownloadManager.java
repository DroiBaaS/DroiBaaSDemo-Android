package com.droi.sdk.droibaasdemo.download;
...
public final class DownloadManager {
    ...
    public synchronized void startDownload(String url, String label, String savePath, String icon, String name, String version, long size,
